      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#00FFFF] h-7 w-7 animate-pulse" />
            <p className="text-2xl">abhirajthakur124@gmail.com</p>
          </div>

          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="text-[#00FFFF] h-7 w-7 animate-pulse" />
            <p className="text-2xl">Pinjore, Haryana, India</p>
          </div>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#00FFFF] px-10 py-5 rounded-md text-black font-bold text-lg 
